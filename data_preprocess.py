# This code is reused from https://github.com/dansuh17/segan-pytorch. However, there are few changes that have been performed.
...
window_size = 16384  # about 1 second of samples
sample_rate = 16000
...
def process_and_serialize(data_type):
    """
    Serialize, down-sample the sliced signals and save in separate folder.
    """
    stride = 0.5
...
def data_verify(data_type):
    """
    Verifies the length of each data after pre-processing.
    """
    if data_type == 'train':
        serialized_folder = serialized_train_folder
    else:
